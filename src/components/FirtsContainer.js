...
import { ReactComponent as ImgFirts } from "../assets/img/undraw_startup_life_2du22.svg";
...
export const FirtsContainer = () => {
  ...
  return (
    <>
      <section
        className={!isMobile ? null : "sectionResponsive"}
        ref={outerRef}
      >
        {inViewport && (
          <div
